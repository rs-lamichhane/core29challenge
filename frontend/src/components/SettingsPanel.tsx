                  ...
                  <div className="space-y-2">
                    {colorBlindOptions.map(opt => (
                      <button
                        ...
                        className={`w-full flex items-center justify-between p-3 rounded-xl border-2 transition-all ${colorBlindMode === opt.key
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    {Object.entries(LANGUAGES).map(([key, { label, flag }]) => (
                      <button
                        ...
                        className={`flex items-center gap-2 p-2.5 rounded-xl border-2 transition-all ${language === key
